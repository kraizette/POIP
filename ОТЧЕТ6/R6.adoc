...
int main()
{
  ...
  for(;;)    
  {
    ...
    uint16_t Cal1 = *tsCal1Pointer;
    uint16_t Cal2 = *tsCal2Pointer;
    ...
    temperature = (100-30) * (ADC_Code - tsCal1) / (tsCal2- tsCal1) + 30 ;

           
  std::cout << "Count: " << ADC_Code << " Temperature: " << temperature <<  std::endl ;
...
int main()
{
  ...
  for(;;)    
  {
    ...
    uint16_t Cal1 = *tsCal1Pointer;
    uint16_t Cal2 = *tsCal2Pointer;
    uint16_t ddaCal = *VddaCalPointer;
    float tsCal1 = Cal1;
    float tsCal2 = Cal2;
    float VddaCal = ddaCal*0.001;
    ...
    float ADC_Code = data;
    float DEGREE_30 = 30.0F;
    temperature = (110-30) * ((ADC_Code * VddaCal)/Vdda -  tsCal1) / (tsCal2 - tsCal1) + DEGREE_30; ; //Convert ADC counts to temperature
